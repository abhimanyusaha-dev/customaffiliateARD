...
if ( ! class_exists( 'CustomAffiliate_Admin' ) ) {
    class CustomAffiliate_Admin {
        ...
        public function __construct() {  
            ...
            /* AQT Stag Code Start*/
            global $visible_categories_for_backend;
            $visible_categories_for_backend=[15,81,116];
            /* AQT Stag Code END*/
            endif;
...
if(get_option('affiliate_current_site')=="AQT_STAG"):
            ...
            { 
                ...
                if($_POST['affiliate_type'] =='custom_affiliate'){
                    ...
                    $data['only_default_var'] = $_POST['only_default_var'];                    
                    $data['cust_aff_text'] = $_POST['cust_aff_text'];
                    $data['cust_aff_button_text'] = $_POST['cust_aff_button_text'];
                    $data['cust_aff_button_link'] = $_POST['cust_aff_button_link'];
                    $data['cust_aff_style'] = $_POST['cust_aff_style'];
                    ...
                    if($_POST['product_bundle'][0]['bundle_product_ids']){
                        $d =  $_POST['product_bundle']; 
                        $data['cust_aff_product_bundles'] =serialize($d);
                    }else{
                         $data['cust_aff_product_bundles'] ="";
                    }
          ...
          <p class="hide custom_affiliate sales_funnel" style="display: none;">
                            ...
                            ?>
                                ...
                                <option value="">--Pages--</option>
                                    ...
                                    <?php 
                                        ...
                                        {
                                    ?>
                                            <option value="<?php echo $page->ID; ?>"><?php echo $page->post_title; ?> [<?php echo $page->ID; ?>]</option>
                                    <?php 
                                        }
                                        ...
                                        {
                                            ?>
                                                    <option value="<?php echo $product_page->ID; ?>"><?php echo $product_page->post_title; ?> - [<?php echo $product_page->ID; ?>]</option>
                                            <?php 
            ...
            <p class=" hide custom_affiliate sales_funnel" style="display: none;">
                <label for="smashing-post-class"><?php _e( "Show Home Page"); ?></label>
                <span class="radio-wrap-cf">
                    <label><input type="radio" name="show_home" value="1" width="100%" checked> Yes</label>
                    <label><input type="radio" name="show_home" value="0" width="100%"> No</label>
                </span>
            </p>
            <p class=" hide custom_affiliate sales_funnel" style="display: none;">
                <label for="smashing-post-class"><?php _e( "Show Default Purifiers (Variable)"); ?></label>
                <span class="radio-wrap-cf">
                    <label><input type="radio" name="only_default_var" value="1" width="100%" > Yes</label>
                    <label><input type="radio" name="only_default_var" value="0" width="100%" checked> No</label>
                </span>
            </p>
            
            </div>
            <div class="funnel_offer_detail hide custom_affiliate sales_funnel"  style="display: none;">
            <h3>Affilate Detail</h3>
            <h6>
                Please use [custom_affiliate_shortcode] to show image text and button
            </h6>
        ...
        <?php
            ...
            <div class="product-rates hide custom_affiliate sales_funnel main" style="display: none;">
                            ...
                            <td class="demo">
                                <select name="product_rates[0][product_id]"  placeholder="Select Products" class="prod_test">
                                    ...
                                    if($product_cats):
                                        foreach($product_cats as $product_cat):
                                            global $visible_categories_for_backend;
                                            if(in_array($product_cat->term_id,$visible_categories_for_backend)):
                                            $args = array(
                                                'post_type'      => 'product',
                                                'posts_per_page' => -1,
                                                'tax_query' => array(
                                            ...
                                            $products = get_posts($args);  ?>
                                            <option>-----<?php echo $product_cat->name;?>-----</option>\
                                            <?php
                                                foreach($products as $product): 
                                                    if(get_post_meta($product->ID,'affiliate-backend-show',true)!="0"):
                                                        ?>
                                                    <option value="<?php echo $product->ID; ?>"><?php echo $product->post_title;?> - (<?php echo $product->ID; ?>)</option>
                                                <?php 
                                                    endif;
                ...
                <table class="form-table wp-list-table widefat fixed posts affiliatewp-bundle-rates">
                    <thead>
                        <tr><td colspan="5">Combo Products</td></tr>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="demo">
                                ...
                                <select name="product_bundle[0][bundle_product_ids][]"  placeholder="Select Products" class="prod_test bundle_product_ids" multiple>
                                    <?php 
                                    if($product_cats):
                                        foreach($product_cats as $product_cat):
                                            global $visible_categories_for_backend;
                                            ...
                                            $products = get_posts($args);  ?>
                                            <optgroup label="<?php echo $product_cat->name;?>">
                                            <?php
                                                foreach($products as $product): 
                                                    if(get_post_meta($product->ID,'affiliate-backend-show',true)!="0"):
                                                        ?>
                            ...
                            <td>
                                ...
                                <select name="product_bundle[0][disc_product_id]"  placeholder="Select Product" class="prod_test disc_product_id">
                                    <?php 
                                    if($product_cats):
                                        foreach($product_cats as $product_cat):
                                            global $visible_categories_for_backend;
                            ...
                            <td>
                                <input name="product_bundle[0][discount]" type="text" value="" class="prod_test" />
                            </td>
                                
                            <td>
                                <input name="product_bundle[0][shipping]" type="text" value="" class="prod_test" />
                            </td> <?php /**/?>
                            <td>
                                <a href="javascript:void(0)" class="custom_aff_remove_bundle_rate" style="background: url(<?php echo home_url(); ?>wp-admin/images/xit.gif) no-repeat;">×</a>
                            </td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
                            <th colspan="1">
                                <button id="custom_aff_new_bundle_rate_woocommerce"  class="button affwp_new_bundle_rate">Add New Product Rate</button>
                            </th>
                            <th colspan="4">
            ...
            <script type="text/javascript">
                jQuery(document).ready(function() {
                    jQuery('.bundle_product_ids').select2({'placeholder':'Choose Products', 'allowClear': true});
                    jQuery('.disc_product_id').select2({'placeholder':'Select Product', 'allowClear': true});
                ...
                jQuery(document).ready(function($) {
                    ...
                    //Bundle Combo Offer
                    $('.affwp_new_bundle_rate').on('click', function(e) {
                        e.preventDefault();
                        var ClosestRatesTable = $(this).closest('.affiliatewp-bundle-rates');
                        ...
                        clone.find( '.prod_test' ).each(function() {
                            ...
                            $( this ).attr( 'name', name ).attr( 'id', name );
                            if($( this ).attr( 'name')=="product_bundle["+count+"][bundle_product_ids][]")
                            {
                                $('.bundle_product_ids').select2({'placeholder':'Choose Products', 'allowClear': true});
                                $(this).next().next().remove();
                            }
                            if($( this ).attr( 'name')=="product_bundle["+count+"][disc_product_id]")
                            {
                                $('.disc_product_id').select2({'placeholder':'Select Product', 'allowClear': true});
                                $(this).next().next().remove();
                            }
                        });
                    });

                    $("body").on("click",".custom_aff_remove_bundle_rate",function(e){ 
                        var ClosestRatesTable = $(this).closest('.affiliatewp-bundle-rates');
                        var count = ClosestRatesTable.find( 'tbody tr' ).length;
                        if(count==1){
                            $(this).closest('tr').find( 'td select' ).val( '' );
...
if(isset($_POST['update-custom-affiliate']))
                            ...
                            ?>
                                ...
                                <option value="">--Pages--</option>
                                    ...
                                    $p=0;
                                        ...
                                        {
                                    ?>
                                            <option <?php if($all_affiliates[0]->page_id == $page->ID){ echo 'selected'; $p++;} ?> value="<?php echo $page->ID; ?>"><?php echo $page->post_title; ?> [<?php echo $page->ID; ?>]</option>
                                    <?php 
                                        }
                                        ...
                                        {
                                            ?>
                                                    <option <?php if($all_affiliates[0]->page_id == $product_page->ID && $p==0){ echo 'selected'; $p++;} ?> value="<?php echo $product_page->ID; ?>"><?php echo $product_page->post_title; ?> - [<?php echo $product_page->ID; ?>]</option>
                                            <?php 
         ...
         <p class=" hide custom_affiliate sales_funnel" style="display: none;">
                <label for="smashing-post-class"><?php _e( "Show Home Page"); ?></label>
                <span class="radio-wrap-cf">
                    <label><input type="radio" name="show_home" value="1" width="100%" <?php echo $all_affiliates[0]->show_home=="1"?"checked":NULL; ?>> Yes</label>
                    <label><input type="radio" name="show_home" value="0" width="100%" <?php echo $all_affiliates[0]->show_home=="0"?"checked":NULL; ?>> No</label>
                </span>
            </p>
            <p class=" hide custom_affiliate sales_funnel" style="display: none;">
                <label for="smashing-post-class"><?php _e( "Show Default Purifiers (Variable)"); ?></label>
                <span class="radio-wrap-cf">
                    <label><input type="radio" name="only_default_var" value="1" width="100%" <?php echo $all_affiliates[0]->only_default_var=="1"?"checked":NULL; ?>> Yes</label>
                    <label><input type="radio" name="only_default_var" value="0" width="100%" <?php echo $all_affiliates[0]->only_default_var=="0"?"checked":NULL; ?>> No</label>
                </span>
            </p>
                ...
                <table class="form-table wp-list-table widefat fixed posts affiliatewp-bundle-rates">
                    ...
                    <?php 
                        ...
                        <tr>
                            ...
                            <select name="product_bundle[<?php echo $j; ?>][bundle_product_ids][]"  placeholder="Select Products" class="prod_test bundle_product_ids" multiple>
                                    <?php 
                                    if($product_cats):
                                        foreach($product_cats as $product_cat):
                                            global $visible_categories_for_backend;
                                            ...
                                            <?php
                                                foreach($products as $product): 
                                                    if(get_post_meta($product->ID,'affiliate-backend-show',true)!="0"):
                                                        ?>
                                                    <option value="<?php echo $product->ID; ?>" <?php echo is_array($value['bundle_product_ids']) && in_array($product->ID,$value['bundle_product_ids'])?'selected':NULL; ?>><?php echo $product->post_title;?> - (<?php echo $product->ID; ?>)</option>
                                                <?php 
                                                    endif;
                                                endforeach;
                                                ?>
                            ...
                            <td>
                                ...
                                <select name="product_bundle[<?php echo $j; ?>][disc_product_id]"  placeholder="Select Product" class="prod_test disc_product_id">
                                    <?php 
                                    if($product_cats):
                                        foreach($product_cats as $product_cat):
                                            global $visible_categories_for_backend;
                                            ...
                                            <?php
                                                foreach($products as $product): 
                                                    if(get_post_meta($product->ID,'affiliate-backend-show',true)!="0"):
                                                        ?>
                                                    <option value="<?php echo $product->ID; ?>" <?php echo isset($value['disc_product_id']) && $product->ID==$value['disc_product_id']?'selected':NULL; ?>><?php echo $product->post_title;?> - (<?php echo $product->ID; ?>)</option>
                                                <?php 
                                                    endif;
                                                endforeach;
                                                ?>
                            ...
                            <td>
                                <input name="product_bundle[<?php echo $j; ?>][discount]" type="text" value="<?php echo isset($value['discount'])?$value['discount']:NULL; ?>" class="prod_test" />
                            </td>
                                
                            <td>
                                <input name="product_bundle[<?php echo $j; ?>][shipping]" type="text" value="<?php echo isset($value['shipping'])?$value['shipping']:NULL; ?>" class="prod_test" />
                            </td> <?php /**/?>
                            <td>
                                <a href="javascript:void(0)" class="custom_aff_remove_bundle_rate" style="background: url(<?php echo home_url(); ?>wp-admin/images/xit.gif) no-repeat;">×</a>
                            </td>
        ...
        <div class="wrap">
            ...
            <div class="settingcontainer">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <label>Treat As Site Like:</label>
                        <div class="form-class">                        
                        <select name="affiliate_current_site"  required>
                            <option value="">-SELECT-</option>
                            <option value="AIRD_LIVE" <?php echo get_option('affiliate_current_site')=='AIRD_LIVE'?'selected':NULL; ?>>AirdoctorPro Live</option>
                            <option value="AIRD_STAG" <?php echo get_option('affiliate_current_site')=='AIRD_STAG'?'selected':NULL; ?>>AirdoctorPro Staging</option>
                            <option value="AQT_STAG" <?php echo get_option('affiliate_current_site')=='AQT_STAG'?'selected':NULL; ?>>AquaTruWater Staging</option>
                            <option value="AQT_LIVE" <?php echo get_option('affiliate_current_site')=='AQT_LIVE'?'selected':NULL; ?>>AquaTruWater Live</option>
    ...
    /* AIRD Live Code Start */
        ...
        <div class="ca-file-export">
            ...
            <div class="ca-sample-file">
                <a href="<?php echo site_url();?>/wp-content/plugins/custom-affiliate/public/sample-1.csv" download="sample.csv">
    ...
    <?php
            ...
            if(!empty($_FILES['import_file']['name']) && $extension == 'csv'){
                ...
                while(($csvData = fgetcsv($csvFile)) !== FALSE){
                        ...
                        //if( !($dataLen == 10) ) continue;
                            ...
                            $ca_title = trim($csvData[0]);
                            //$custom_slug = trim($csvData[2]);
                            $custom_slug = trim($csvData[2]);
                            if(!empty($custom_slug)):
                                $check_exists = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}custom_affiliate where custom_slug LIKE '$custom_slug'");
                                if(!empty($check_exists)):
                                    $wpdb->delete( "{$wpdb->prefix}custom_affiliate", array( 'custom_slug' => $custom_slug ) );
                                endif;
                            endif;
                            $affiliate = trim($csvData[1]);
                            if(strtolower($affiliate) =='sales'){
                                $affiliate_type ="sales_funnel";
                            }
                            if(strtolower($affiliate) =='custom'){
                            ...
                            $cust_aff_text =trim($csvData[6]);
                            $cust_aff_button_text =trim($csvData[7]);
                            $cust_aff_button_link =trim($csvData[8]);
                            $traffic_source =strtolower(str_replace(' ','_',$csvData[3]));
                            //$cust_aff_product_cat[0] = array('cat_id'=> 15,'discount'=>'','rate'=>'percentage');
                            //$cust_aff_product_cat[1] = array('cat_id' => 81, 'discount' =>'', 'rate' => 'percentage' );
                            $cust_aff_style =trim($csvData[9]);
                            $product_cat_rates=[];
                            if(!empty($csvData[10])):
                                $category_rates=explode("#",$csvData[10]);
                                if(!empty($category_rates)): 
                                    $new_count=0;
                                    foreach($category_rates as $category_rate):
                                        if(!empty($category_rate)){
                                            $category_rate_arr=explode("|",$category_rate);
                                            $product_cat_rates[$new_count]['cat_id']=$category_rate_arr[0];
                                            if($category_rate_arr[1]=="_")
                                            {
                                                $product_cat_rates[$new_count]['discount']="";
                                            }
                                            else
                                            {
                                                $product_cat_rates[$new_count]['discount']=$category_rate_arr[1];
                                            }
                                            $product_cat_rates[$new_count]['rate']=$category_rate_arr[2];
                                            // $product_cat_rates[$new_count]['shipping']=$category_rate_arr[3];
                                            
                                            if($category_rate_arr[1]=="_")
                                            {
                                                $product_cat_rates[$new_count]['shipping']="";
                                            }
                                            else
                                            {
                                                $product_cat_rates[$new_count]['shipping']=$category_rate_arr[3];
                            ...
                            if(!empty($csvData[11])):
                            $product_disc_rates=[];
                            $product_rates=explode("#",$csvData[11]);
                                if(!empty($product_rates)): 
                                    $new_count=0;
                                    foreach($product_rates as $product_rate):
                                        if(!empty($product_rate)){
                                            $product_rate_arr=explode("|",$product_rate);
                                            $product_disc_rates[$new_count]['product_id']=$product_rate_arr[0];
                                            if($product_rate_arr[1]=="_")
                                            {
                                                $product_disc_rates[$new_count]['discount']="";
                                            }
                                            else
                                            {
                                                $product_disc_rates[$new_count]['discount']=$product_rate_arr[1];
                                            }
                                            $product_disc_rates[$new_count]['rate']=$product_rate_arr[2];
                                            if($product_rate_arr[1]=="_")
                                            {
                                                $product_disc_rates[$new_count]['shipping']="";
                                            }
                                            else
                                            {
                                                $product_disc_rates[$new_count]['shipping']=$product_rate_arr[3];
                                            }
                            ...
                            $insert_arrays[] = array(
                                  ...
                                  'page_id' =>$page_id,
                                  'cust_aff_product'=>'',
                                  'cust_aff_product_cat'=>serialize($product_cat_rates),
                                  'cust_aff_product'=>serialize($product_disc_rates),
                                  'cust_aff_text' =>$cust_aff_text,
                                  'cust_aff_button_text' =>$cust_aff_button_text,
                                  'cust_aff_button_link' =>$cust_aff_button_link,
                                  'land_page_url' => $land_page_url,
                                  'traffic_source' =>$traffic_source,
                                  'cust_aff_style' => $cust_aff_style
                                  );
        ...
        <div class="ca-file-export">
            ...
            <div class="ca-sample-file">
                <a href="<?php echo site_url();?>/wp-content/plugins/custom-affiliate/public/sample-AIRD.csv" download="sample-AIRD.csv">
                <button>Download Sample File</button>
                </a>
            </div>
        </div>
    <?php
            ...
            if(!empty($_FILES['import_file']['name']) && $extension == 'csv'){
                ...
                while(($csvData = fgetcsv($csvFile)) !== FALSE){
                        ...
                        //if( !($dataLen == 10) ) continue;
                            ...
                            //     $cust_aff_shipping_price = 0;
                            // }
                            $show_home_page =trim($csvData[6])=="Yes"?1:0;
                            $show_default_vars =trim($csvData[7])=="Yes"?1:0;
                            $cust_aff_text =trim($csvData[8]);
                            $cust_aff_button_text =trim($csvData[9]);
                            $cust_aff_button_link =trim($csvData[10]);
                            $cust_aff_style =trim($csvData[11]);
                            $product_cat_rates=[];
                            if(!empty($csvData[12])):
                                $category_rates=explode("#",$csvData[12]);
                                if(!empty($category_rates)): 
                                    $new_count=0;
                                    foreach($category_rates as $category_rate):
                                        if(!empty($category_rate)){
                            ...
                            if(!empty($csvData[13])):
                            $product_disc_rates=[];
                            $product_rates=explode("#",$csvData[13]);
                                if(!empty($product_rates)): 
                                    $new_count=0;
                                    foreach($product_rates as $product_rate):
                                        if(!empty($product_rate)){
                            ...
                            $insert_arrays[] = array(
                                  ...
                                  'only_default_var' => $show_default_vars
                                  );
        ...
        <div class="ca-file-export">
            ...
            <div class="ca-sample-file">
                <a href="<?php echo site_url();?>/wp-content/plugins/custom-affiliate/public/sample-AQT.csv" download="sample.csv">
                <button>Download Sample File</button>
                </a>
            </div>
        </div>
    ...
    if(get_option('affiliate_current_site')=="AQT_LIVE"):
        ...
        <div class="ca-file-export">
            ...
            <div class="ca-sample-file">
                <a href="<?php echo site_url();?>/wp-content/plugins/custom-affiliate/public/sample-1-AIRD.csv" download="sample.csv">
                <button>Download Sample File</button>
                </a>
            </div>
        </div>
...
add_action ( 'admin_init', function(){
    ...
    if(get_option('affiliate_current_site')=="AQT_STAG"):
        ...
        require_once(get_stylesheet_directory().'/php-export-data.class.php');
        $exporter = new ExportDataExcel('browser', 'AquaTru Affiliates.xls');
        ...
        if($all_affiliates){
            foreach ($all_affiliates as $each_affiliate) {   
                ...
                if($each_affiliate->affiliate_type =='generic_affiliate'):
                    $exporter->addRow(array($each_affiliate->ca_title,$each_affiliate->custom_slug,ucwords(str_replace("_"," ",$each_affiliate->affiliate_type)),ucwords(str_replace("_"," ",$each_affiliate->traffic_source)),$each_affiliate->scriptcode,$each_affiliate->offer_text,$each_affiliate->offer_button_text,$each_affiliate->offer_button_link,$each_affiliate->offer_start_time,$each_affiliate->offer_end_time,ucwords($each_affiliate->affiliate_offering_status),'','','','','','','','','','','','','',''));
                    $exporter->addRow([]);
                else:
                    $exporter->addRow(array($each_affiliate->ca_title,$each_affiliate->custom_slug,ucwords(str_replace("_"," ",$each_affiliate->affiliate_type)),ucwords(str_replace("_"," ",$each_affiliate->traffic_source)),$each_affiliate->scriptcode,$each_affiliate->offer_text,$each_affiliate->offer_button_text,$each_affiliate->offer_button_link,$each_affiliate->offer_start_time,$each_affiliate->offer_end_time,ucwords($each_affiliate->affiliate_offering_status),ucwords($each_affiliate->cust_aff_text),ucwords($each_affiliate->cust_aff_button_text),ucwords($each_affiliate->cust_aff_button_link),ucwords($status),'','','','','','','','',$page_title,$each_affiliate->land_page_url));
                    $cust_aff_product_cat=unserialize($each_affiliate->cust_aff_product_cat);
                    $cust_aff_product=unserialize($each_affiliate->cust_aff_product);
                    if(!empty($cust_aff_product_cat) || !empty($cust_aff_product)):
                        $newarr['cat_array']=$cust_aff_product_cat;
        ...
        $exporter->addRow(array('Title','Custom Slug','Type','Traffic Source','Scriptcode','Promotion Offer Text','Promotion Offer Button Text','Promotion Offer Button Link','Promotion Offer Start Time
        ','Promotion Offer End Time','Funnel Offer Status','Affiliate Name','Affilate Button Text','Affilate Button Link','Status','','Product Categories','','','','Products','',)); 
        $exporter->addRow(array('','','','','','','','','','','','','','','','Category Name','Category Discount','Discount Rate','Category Shipping','Product Name','Product Discount','Discount Rate','Product Shipping','Landing Page','Landing Page URL'));
        if($all_affiliates){
            foreach ($all_affiliates as $each_affiliate) {   
                $status="";         
                if($each_affiliate->affiliate_type =='main'){
